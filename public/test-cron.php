...
use App\Console\Commands\CancelExpiredShareAndTalkSessions;
use App\Console\Commands\CleanupExpiredSessions;
use App\Console\Commands\CleanupExpiredTickets;
use App\Console\Commands\MarkSgdGroupsDone;
...
try {
    ...
    $sessionCount = ChatSession::whereIn('status', ['waiting', 'pending'])->count();
    ...
    $shareTalkCommand = new CancelExpiredShareAndTalkSessions;
    ...
    $sessionsCommand = new CleanupExpiredSessions;

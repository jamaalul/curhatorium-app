                        ...
                        <div class="w-64 flex flex-col justify-start items-center gap-4">
                            ...
                            <div class="w-auto bg-white rounded-[9.45px] outline outline-1 outline-gray-200 flex flex-col justify-start items-start">
                                <div class="size-44 relative rounded-md overflow-hidden flex justify-center items-center bg-white p-2">
                                    ...
                                    <img id="qr-image" src="{{ $isQrUrl ? $latestPayment->qris_url : '' }}" alt="QR Code" class="w-full h-full object-contain mix-blend-multiply {{ $isQrUrl ? '' : 'hidden' }}" />
                                </div>
                            </div>
                            ...
                            <div class="w-full flex justify-center items-center gap-2">
                                ...
                                <a id="qr-download-link" href="{{ $isQrUrl ? $latestPayment->qris_url : '#' }}" download="QRIS-{{ $order->order_ref }}.png" target="_blank" class="text-center text-teal-500 text-base font-medium font-dm leading-7 hover:underline">Unduh QR</a>
                            </div>
                        </div>

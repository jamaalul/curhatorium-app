...
<body class="w-full">
    <nav class="w-full h-16 bg-white flex items-center px-4 fixed top-0 left-0 z-50 gap-6">
        ...
        <!-- Mobile login button -->
        <a href="/login"
            class="px-4 py-2 bg-[#48A6A6] text-white rounded-md transition-colors duration-200 hover:bg-[#48A6A6]">Masuk</a>
    </nav>
    ...
    <section class="w-full h-fit md:h-screen bg-white pb-4 px-4 pt-16" id="hero">
        ...
        <div class="h-full w-full bg-cover rounded-xl flex flex-col items-center overflow-hidden shadow-md p-4"
    ...
    <section class="w-full h-fit bg-white pt-0 md:pt-24" id="statistics">
        <div class="h-full w-full rounded-xl flex flex-col items-center overflow-hidden p-4">
            ...
            <p class="text-gray-600 mb-6 text-center text-base md:text-lg">Ratusan pengguna telah merasakan manfaat
                Curhatorium, tempat aman untuk berbagi, mendapatkan dukungan, dan tetap anonim kapan saja.</p>
            <div class="w-full">
                <div
                    class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 mt-7 overflow-hidden rounded-lg border border-[#323232]">
    ...
    <section class="w-full relative">
        <div class="grid grid-cols-2 md:grid-cols-4">
            <div class="aspect-[4/3] bg-gray-300 bg-cover bg-center"
                style="background-image: url('images/gal1.jpg');"></div>
            <div class="aspect-[4/3] bg-gray-300 bg-cover bg-center"
                style="background-image: url('images/gal2.jpg');"></div>
            <div class="aspect-[4/3] bg-gray-300 bg-cover bg-center"
                style="background-image: url('images/gal3.jpg');"></div>
            <div class="aspect-[4/3] bg-gray-300 bg-cover bg-center"
                style="background-image: url('images/gal4.jpg');"></div>
            <div class="aspect-[4/3] bg-gray-300 bg-cover bg-center"
                style="background-image: url('images/gal5.jpg');"></div>
            <div class="aspect-[4/3] bg-gray-300 bg-cover" style="background-image: url('images/gal6.jpg');"></div>
            <div class="aspect-[4/3] bg-gray-300 bg-cover bg-center"
                style="background-image: url('images/gal7.jpg');"></div>
            <div class="aspect-[4/3] bg-gray-300 bg-cover bg-center"
                style="background-image: url('images/gal8.jpg');"></div>
        </div>
        <div class="w-full bottom-0 h-1/2 absolute flex left-0 right-0"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                @php
                    $membershipMeta = [
                        ...
                        'Harmony' => [
                            'price' => 19900,
                            'benefits' => ['(1x) Support Group Discussion'],
                        ],
                        'Serenity' => [
                            'price' => 15000,
                            'benefits' => ['(1x) Share and Talk via Chat w/ Rangers'],
                        ],
                ...
                @foreach ($membershipMeta as $name => $meta)
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md ease-in-out text-center flex flex-col{{ $isTerpopuler ? ' border-2 border-[#48A6A6]' : '' }}"
                        ...
                        <p class="text-4xl font-bold text-[#48A6A6] mb-4">
                            Rp{{ number_format($meta['price'], 0, ',', '.') }}</p>
    ...
    <section class="w-full bg-cover bg-center py-12 md:py-20 px-2 md:px-4 overflow-hidden"
        ...
        <div class="max-w-4xl mx-auto text-center bg-white/80 backdrop-blur-sm p-4 md:p-10 rounded-lg shadow-xl"
            ...
            <a href="/register"
                class="bg-[#48A6A6] text-white py-2 md:py-3 px-4 md:px-8 rounded-md text-base md:text-lg hover:bg-[#357979] transition-colors duration-200 block w-fit mb-4 md:mb-0 mx-auto">Gabung
                Sekarang</a>
    ...
    <button id="tutorial-btn"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" style="width: 1.5rem; height: 1.5rem; flex-shrink: 0;">
            <path stroke-linecap="round" stroke-linejoin="round"

...
<body class="bg-gray-100 flex flex-col items-center min-h-screen justify-center gap-4">
    ...
    <div class="flex flex-col items-center gap-4">
        ...
        <a href="{{ route('share-and-talk.index') }}" class="flex items-center gap-2 text-[#48a6a6] py-3 px-6 rounded-md hover:text-[#357979] transition-colors duration-200 font-semibold">

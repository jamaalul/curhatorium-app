    ...
    <div class="flex md:flex-row flex-col gap-10 mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-7xl">
        ...
        <div class="w-full md:w-3/4">
            ...
            <div class="flex justify-between items-center mb-8 pb-4 border-gray-200 border-b">
                <div>
                    @auth
                        <a href="{{ route('ebooks.library') }}" class="inline-flex items-center gap-2 bg-black text-white px-4 py-2 rounded-xl text-sm font-dm font-medium hover:bg-gray-800 transition-colors">

...
<body class="w-screen h-screen flex bg-gray-800">
    ...
    <div id="sidebar" class="bg-gray-800 text-white flex flex-col p-4 w-64 transition-all duration-300 ease-out overflow-hidden">
        ...
        <div class="flex-1 min-h-0 overflow-y-auto w-full mt-4 pb-4" style="scrollbar-width:thin; scrollbar-color:#374151 #1f2937;">
            ...
            <div class="group w-full hover:bg-gray-700 transition-all duration-100 flex items-center gap-2 p-2 pr-7 rounded-md cursor-pointer text-gray-300 hover:text-white relative" onclick="window.location.href = '/mental-support-chatbot/{{ $title->identifier }}'">
